...
class CreateBTRequisitionItems22Table extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('b_t_requisition_items_22', function (Blueprint $table) {
    ...
    {
        Schema::dropIfExists('b_t_requisition_items_22');
    }
}
