...
class CreateATRequisitionItems22Table extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('a_t_requisition_items_22', function (Blueprint $table) {
    ...
    {
        Schema::dropIfExists('a_t_requisition_items_22');
    }
}
