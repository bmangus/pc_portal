    ...
    export default {
        ...
        methods: {
            ...
            loadActive(){
                ...
                this.loading = true;
                this.actor = "";
                axios.get('/staff/atWorkflowBackend')
                    .then(response => {
            ...
            loadCompleted(){
                ...
                this.noRequisitions = false;
                this.actor = "";
                axios.get('/staff/atWorkflowBackend/status/Approved')
                    .then(response => {
                        if(response.data.length < 1){
                            this.noRequisitions = true;
                        } else {
            ...
            loadRejected(){
                ...
                this.noRequisitions = false;
                this.actor = "";
                axios.get('/staff/atWorkflowBackend/status/Rejected')
                    .then(response => {
                        if(response.data.length < 1){
                            this.noRequisitions = true;
                        } else {
            ...
            impersonate(){
                ...
                this.loading = true;
                this.noRequisitions = false;
                axios.get('/staff/atWorkflowBackend/user/' + this.actor)
                    .then(response => {
                        if(response.data.length < 1){
                            this.noRequisitions = true;
                        } else {
            ...
            manualSync(){
                ...
                axios.get('/staff/workflowATBackendSync')
                    .then(res=>{
                        console.log(res);
                        if(this.actor === ""){
                            this.loadActive();
