    ...
    <div class="w-full m-3">
        ...
        <div class="flex">
            ...
            <div class="mt-3 ml-auto mr-2">
                ...
                <span v-show="authUser.SuperUser === 'Yes'" class="btn-primary mb-2 p-3 mr-2 ml-2" @click="manualSync"><span v-if="loadingSync"><font-awesome-icon icon="spinner" spin/></span>Sync</span>
            </div>
        </div>
